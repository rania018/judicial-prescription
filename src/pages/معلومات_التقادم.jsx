      ...
      <div className="card">
        <div className="card-header">
          <div>
            ...
            <div className="card-subtitle">
              يتم تحديث الحالة آلياً مرة كل 24 ساعة عبر الوظيفة السحابية المجدولة.
            </div>
          </div>
        </div>
        <p className="muted">
          تعتمد الحالة على عدد الأيام المتبقية حتى <strong>تاريخ انتهاء
          التقادم</strong> (المحسوب في الخلفية) كما يلي:
        </p>
        <ul className="info-list">
          <li>
            <strong>غير قابلة للتقادم (NON_PRESCRIPTIBLE):</strong> القضايا المستثناة من السقوط.
          </li>
          <li>
            <strong>منتهية (EXPIRED):</strong> المتبقي ≤ 0 يوم.
          </li>
          <li>
            <strong>حرجة (CRITICAL):</strong> المتبقي ≤ 7 أيام.
          </li>
          <li>
            <strong>عاجلة (URGENT):</strong> المتبقي ≤ 15 يوماً.
          </li>
          <li>
            <strong>تنبيه (WARNING):</strong> المتبقي ≤ 90 يوماً.
          </li>
          <li>
            <strong>سارية (ACTIVE):</strong> المتبقي &gt; 90 يوماً.
          </li>
        </ul>
        <p className="muted">
          لا يتم تعديل الحالة من واجهة المستخدم، بل حصراً عن طريق الوظيفة السحابية
          المجدولة وفق القواعد أعلاه.
        </p>
      </div>
