  ...
  return (
    <div>
      <div className="page-header">
        <h2 className="page-title">دليل آجال التقادم وإجراءات المتابعة</h2>
      </div>
        ...
        <div className="card-header">
          <div>
            ...
            <div className="card-subtitle">
              يعتمد النظام على مسارين منفصلين لتقادم الدعوى الجزائية:
            </div>
          </div>
        </div>
      ...
      <div className="card">
        <div className="card-header">
          <div>
            ...
            <div className="card-subtitle">
              يطبّق النظام مدد التقادم التالية آلياً عند إنشاء القضية
            </div>
          </div>
        </div>
        <ul className="info-list">
      ...
      <div className="card">
        <div className="card-header">
          <div>
            ...
            <div className="card-subtitle">
              يمكن أن يتأثر سريان التقادم بعدة آليات قانونية.
            </div>
          </div>
        </div>
        <ul className="info-list">
          <li>
            <strong>الانقطاع (Interruption):</strong> يُعاد احتساب المدة من جديد، ويحدث ذلك عند:
            <ul>
          ...
          <li>
            <strong>الوقف (Suspension):</strong> يُجمَّد احتساب المدة إلى حين زوال سبب الوقف، ثم يُستأنف العدّ من حيث توقف:
            <ul>
              <li>يُستخدم لحالات محددة مثل تواري المتهم أو عدم إمكانية الوصول إليه</li>
              <li>عند زوال سبب الوقف، يستمر احتساب المدة من النقطة التي توقف عندها</li>
            </ul>
          </li>
        </ul>
      </div>
      ...
      <div className="card">
        <div className="card-header">
          <div>
            ...
            <div className="card-subtitle">
              تُحتسب الحالة وفق قواعد موحّدة تُطبَّق في اللوحة والشارات وجميع صفحات النظام.
            </div>
          </div>
        </div>
        <p className="muted">
        ...
        <ul className="info-list">
          ...
          <li>
            <strong>حرجة — أقل من 6 أشهر (CRITICAL):</strong> أقل من ستة أشهر متبقية.
          </li>
          <li>
            <strong>قيد المتابعة — أقل من سنة (WARNING):</strong> من ستة أشهر إلى سنة متبقية.
          </li>
          <li>
      ...
      <div className="card">
        ...
        <ul className="info-list">
          ...
          <li>
            <strong>القاضي (JUDGE):</strong> يمكنه اتخاذ الإجراءات القضائية على القضايا المكلَّف بها، بما في ذلك تسجيل الانقطاع والوقف واستئناف الوقف.
          </li>
          <li>
            <strong>النيابة العامة (PUBLIC_PROSECUTOR):</strong> يمكنها الإشراف على القضايا ضمن نطاق المحكمة، وإضافة جميع أنواع الإجراءات التي تؤدي إلى انقطاع التقادم، كما يمكنها تسجيل حالات الوقف واستئنافها.
          </li>
          <li>
            <strong>المحامي العام (ATTORNEY_GENERAL):</strong> يملك جميع صلاحيات النيابة العامة على مستوى المجلس القضائي، بالإضافة إلى إدارة صلاحيات المستخدمين ومراجعة سجلات الأثر الرقابي.
          </li>
        </ul>
      </div>
      ...
      <div className="card">
        <div className="card-header">
          <div>
            ...
            <div className="card-subtitle">
              الحقول التي يخزنها النظام أو يحتسبها تلقائياً لضمان اتساق البيانات.
            </div>
          </div>
        </div>
        <ul className="info-list">
          ...
          <li>
            <strong>عند إضافة وقف:</strong> يُجمَّد احتساب المدة، ثم يُستأنف العدّ من حيث توقف عند رفع الوقف.
          </li>
        </ul>
      </div>
