  ...
  return (
    <div>
      ...
      <div className="card">
        ...
        <ul className="info-list">
          <li>
            <strong>أمين الضبط:</strong> يمكنه تسجيل القضايا لأول مرة واستخراج بطاقة المعلومات، ولا يمكنه إضافة
            إجراءات انقطاع أو وقف.
          </li>
          <li>
          ...
          <li>
            <strong>وكيل الجمهورية:</strong> يملك حق الاطلاع الرقابي على ملفات قضاة المحكمة ضمن نفس المحكمة دون
            تصرف، وله حق التصرف الكامل في ملفاته الخاصة فقط.
          </li>
          <li>
            <strong>النائب العام:</strong> يملك حق الاطلاع الشامل على ملفات قضاة المجلس ضمن نفس المجلس دون
            تصرف، وله حق التصرف الكامل في ملفاته الخاصة فقط، إضافة إلى إدارة المستخدمين.
          </li>
        </ul>
      </div>
