  ...
  return (
    <div>
      ...
      <div className="card">
        ...
        <ul className="info-list">
          <li>
            <strong>أمين الضبط:</strong> يمكنه تسجيل قضايا جديدة، ولا يمكنه إضافة إجراءات انقطاع أو وقف.
          </li>
          <li>
          ...
          <li>
            <strong>النيابة العامة:</strong> يمكنها الإشراف على القضايا ضمن نطاق المحكمة، وإضافة جميع أنواع الإجراءات التي تؤدي إلى انقطاع التقادم، كما يمكنها تسجيل حالات الوقف واستئنافها.
          </li>
          <li>
            <strong>المحامي العام:</strong> يملك جميع صلاحيات النيابة العامة على مستوى المجلس القضائي، بالإضافة إلى إدارة صلاحيات المستخدمين ومراجعة سجلات الأثر الرقابي.
          </li>
        </ul>
      </div>
