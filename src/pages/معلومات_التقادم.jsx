  ...
  return (
    <div>
      <div className="page-header">
        <h2 className="page-title">معلومات حول آجال التقادم وآلية المتابعة</h2>
      </div>
      ...
      <div className="card">
        ...
        <ul className="info-list">
          <li>
            <strong>أمين الضبط:</strong> يمكنه تسجيل القضايا لأول مرة واستخراج بطاقة المعلومات، ولا يمكنه
            إضافة إجراءات انقطاع أو وقف.
          </li>
          <li>
            <strong>القاضي:</strong> يمكنه اتخاذ الإجراءات القضائية على القضايا المكلَّف بها، بما في ذلك تسجيل الانقطاع والوقف واستئناف الوقف.
          </li>
          <li>
            <strong>وكيل الجمهورية:</strong> يملك حق الاطلاع الرقابي على ملفات قضاة المحكمة ضمن نفس
            المحكمة دون تصرف، وله حق التصرف الكامل في ملفاته الخاصة فقط.
          </li>
          <li>
            <strong>النائب العام:</strong> يملك حق الاطلاع الشامل على ملفات قضاة المجلس ضمن نفس
            المجلس دون تصرف، وله حق التصرف الكامل في ملفاته الخاصة فقط، إضافة إلى إدارة المستخدمين.
          </li>
        </ul>
      </div>
